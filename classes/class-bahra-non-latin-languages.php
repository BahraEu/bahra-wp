...
if ( ! class_exists( 'Bahra_Non_Latin_Languages' ) ) {
	/**
	 * Language handling.
	 */
	class Bahra_Non_Latin_Languages {
		...
		public static function get_non_latin_css( $type = 'front-end' ) {
			...
			$font_family = apply_filters(
				'Bahra_get_localized_font_family_types',
				array(
			...
			$elements = apply_filters(
				'Bahra_get_localized_font_family_elements',
				array(
			...
			return Bahra_generate_css( implode( ',', $elements[ $type ] ), 'font-family', implode( ',', $font_family[ $locale ] ), null, null, false );
