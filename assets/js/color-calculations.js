 ...
 * @return {Object} - this
 */
function _bahraColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_bahraColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_bahraColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_bahraColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _bahraColor object.
 *
 * @since Twenty Twenty 1.0
 *
 * @param {string} backgroundColor - The background color.
 ...
 * @return {Object} - this
 */
function bahraColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _bahraColor( backgroundColor, accentHue );
